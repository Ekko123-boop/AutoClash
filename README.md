...
- **Focused <--> Global Proximity Slider**: Fine-tune spatial clustering range from 1 to 300 ft (precisely mapped to Navisworks internal meter coordinates).
...
### 6. Remote License Control & Stealth Mode
- **Stealth Coworker Mode**: Zero trial popups, warnings, or countdowns for end users. Full offline functionality.
- **Cloud Administration**: Instant remote authorization or revocation via Firebase Realtime Database.
